...
public class AccountSettings extends AppCompatActivity {
    ...
    private TextInputEditText newPass, passConfirm;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_setting_hurry);
        logout = findViewById(R.id.logout_btn);
        newPass = findViewById(R.id.newPass);
        passConfirm = findViewById(R.id.retypePass);
        this.clickEvents();
    }
    ...
    private void clickEvents() {
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth.signOut();
                AccountSettings.super.onBackPressed();
            }
        });
    }
}
...
//        //titleView.setText("lol it aao");
//
//        mSlidingTabLayout = (SlidingTabLayout) findViewById(R.id.sliding_tabs);
//        mSlidingTabLayout.setCustomTabView(R.layout.tab_indicator, android.R.id.text1);
//        mSlidingTabLayout.setSelectedIndicatorColors(getResources().getColor(R.color.greenYellow));
...
//        final CircleImageView settings_profile_image = (CircleImageView) findViewById(R.id.settings_profile_image);
//
//        mAuth = FirebaseAuth.getInstance();
